...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white px-4">
      ...
      {/* MAIN LOGIN CARD (Instagram Style) */}
      <div className="w-full max-w-[350px] flex flex-col gap-6"> {/* Added gap-6 for spacing */}
        ...
        <div className="border border-[#363636] bg-black p-10 flex flex-col items-center">
          ...
          <form onSubmit={handleLogin} className="w-full flex flex-col gap-3"> {/* Added gap-3 between inputs */}
            
            {/* EMAIL INPUT (Instagram Style) */}
            ...
            {/* PASSWORD INPUT (Instagram Style) */}
            <div className="relative group">
              <input
                type="password"
        ...
        {/* BOTTOM BOX (Instagram "Sign Up" style box) */}
